...
export default function NavMenu({lang,handleLangChange,handleNavChange}) {
    return (
        <div className="flex flex-col md:flex-row items-center w-full md:w-auto py-2">
            ...
            <button onClick={()=>handleNavChange('About')} className="hover:shadow-lg shadow-cyan-200 rounded px-4 py-2 text-white w-5/6 md:w-auto">About</button>
            <button onClick={()=>handleNavChange('Projects')} className="hover:shadow-lg shadow-cyan-200 rounded px-4 py-2 text-white w-5/6 md:w-auto">Projects</button>
