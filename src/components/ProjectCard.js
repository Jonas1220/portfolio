...
export default function ProjectCard({lang}) {
    return (
        <div className="bg-blue-100 w-full p-5 mb-4">
            ...
            {/* <a href="url" target='_blank' rel="noreferrer" className="flex justify-center items-center mt-2 py-2 w-20 hover:scale-125 ease-in-out duration-200 delay-75 text-sm text-center bg-indigo-500 shadow-lg shadow-indigo-300 rounded-lg text-white"><PiShareFat className="text-xl mr-1"/> {L['open'][lang]}</a> */}
